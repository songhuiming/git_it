...
cm = pd.read_excel('H:\work\IFRS9\PCCA\CI\pc_ca_cnt_cum_pd_from_sas.xlsx', sheetname = 'I2to7')   # cum pd from sas, need to normalize it
...
f = 'cum_pd_num~ gdp_v1 + gdp_p2 + bbbspread_v1 +  quarters_'	 
