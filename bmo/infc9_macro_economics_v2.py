...
cm = pd.read_excel('H:\work\IFRS9\CM\qtr_summary_cm_cm_20150921.xlsx', sheetname = 'I2to7')   # normalized cum pd
...
mean_stdev = pd.read_excel('H:\work\IFRS9\CM\qtr_summary_cm_cm_20150921.xlsx', sheetname = 'mean_stdev')
for i in range(25):
