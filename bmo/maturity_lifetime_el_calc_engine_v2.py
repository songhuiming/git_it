...
# read in loan info
loan_info = pd.read_csv( r'H:\work\IFRS9\Jimmy_calc_engine\maturity_lifetime_el_engine.csv')

# part 1: prep for 0 to 75 months
cum_pd = pd.read_excel(r'H:\work\IFRS9\Jimmy_calc_engine\Effective Maturity Tables & Lifetime EL Calculation.xlsx', sheetname = 'cum_pd')
